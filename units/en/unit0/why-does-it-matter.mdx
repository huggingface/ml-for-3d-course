...
It's a popular claim that we need 3D for the next big leap in AI. However, there is no concensus on _how_ 3D should be represented or what it looks like to _understand_ the 3D world.
