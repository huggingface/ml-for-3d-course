...
This is a simplification, but highlights the challenges in the 3D machine learning landscape broadly.
...
In the meantime, it's useful to understand the all building blocks of current 3D machine learning research. Starting with, [non-meshes](non-meshes.mdx).
