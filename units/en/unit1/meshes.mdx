...
While progress has been very rapid in Step 1, Step 2 has been relatively unchanged since the 1980s. This creates a gap between 3D research, which produces advancements in Step 1, and 3D applications, which rely on the final output of Step 2.

This is a simplification, but it broadly highlights the challenges in the 3D machine learning landscape.
...
In the meantime, it's useful to understand the building blocks of current 3D machine learning research, starting with [non-meshes](non-meshes.mdx).