...
Fortunately, this can be treated as a black box in most cases. You don't need to understand the details of these non-mesh representations to use them in your work.
