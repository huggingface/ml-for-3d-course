...
However, multi-view diffusion is just one of many models available and used in generative 3D tasks.
...
3. **Create your own Model**: If you aren't familiar with machine learning concepts, get familiar with the basics by following the [NLP Course](https://huggingface.co/learn/nlp-course/chapter1/1). Even if you aren't interested in NLP, this course provides an in-depth introduction to machine learning concepts.
