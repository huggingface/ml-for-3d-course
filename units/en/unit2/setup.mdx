...
If the notebook asks you to restart the session, do so, then run the code block again. If everything installed correctly, you should see a green checkmark next to the code block.
