...
However, it doesn't work out-of-the-box. It tends to suffer from somethines called the Janus problem, where objects have multiple faces (or more generally, lack of consistency across views).
